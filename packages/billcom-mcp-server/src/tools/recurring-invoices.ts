...
export function registerRecurringInvoiceTools(server: McpServer): void {
  server.tool(
    ...
    "List recurring invoices from your Bill.com account. Supports filtering and sorting.",
    {
      ...
      filters: z.string().optional().describe("Field name, operator, and value for filtering. Format: field:op:value or compound field1:op:value,field2:op:value. Example: customerId:eq:abc123"),
    },
