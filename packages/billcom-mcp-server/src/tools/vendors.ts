...
export function registerVendorTools(server: McpServer): void {
  server.tool(
    "list_vendors",
    "List vendors from your Bill.com account. Returns vendor names, emails, and IDs. Supports filtering and sorting.",
    {
        ...
        content: [
          {
            type: "text" as const,
            text: JSON.stringify(
              { vendors: data.results, nextPage: data.nextPage, prevPage: data.prevPage },
              null,
              2
            ),
          },
